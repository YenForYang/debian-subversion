...
XS(_wrap_svn_fs_file_md5_checksum) {
  {
    ...
    {
      /*@SWIG:/usr/share/swig3.0/perl5/perltypemaps.swg,59,%append_output@*/ if (argvi >= items) EXTEND(sp,1); /*@SWIG:/usr/share/swig3.0/perl5/perltypemaps.swg,56,%set_output@*/ ST(argvi) = sv_2mortal(newSVpv(svn_md5_digest_to_cstring(arg1,
            _global_pool),
          0)); argvi++ /*@SWIG@*/
